...
export function buildDashboardModel(summary, t, enumLabel) {
  ...
  return {
    ...
    requestStages: [
      ...
      { label: "Approved", value: ticketCounts.approved, status: "approved", unavailable: tickets.approved == null },
      { label: "In Progress", value: inProgress, status: "pending" },
      { label: "Completed", value: completed, status: "completed" },
      { label: "Rejected", value: ticketCounts.rejected, status: "rejected", unavailable: tickets.rejected == null },
    ],
    assetConditions: [
      { label: "Good condition", value: goodAssets, status: "online" },
      { label: "Needs repair", value: assetCounts.damaged, status: "rejected" },
      { label: "Under maintenance", value: assetCounts.underRepair, status: "pending" },
      { label: "Retired", value: assetCounts.retired + assetCounts.destroyed, status: "offline" },
    ],
